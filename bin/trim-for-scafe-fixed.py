...
logging.info('Skipped {:,} reads ({}%) total. Breakdown below.'.format(skipped_softclipping + skipped_no_GGG, round((skipped_softclipping + skipped_no_GGG)/total_reads*100, 3)))
